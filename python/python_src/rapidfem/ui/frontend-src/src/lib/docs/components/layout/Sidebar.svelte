<script lang="ts">
	...
	import { ApiToc } from '$lib/docs/components/api';
	import { getSidebarItems } from '$lib/docs/config/rapidfem';
	import type { APIPackage, VersionManifest } from '$lib/docs/api/types';
	import { buildSearchItems, createSearch, runSearch, type SearchItem } from '$lib/docs/search';
